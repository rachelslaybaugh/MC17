...
\nal
Convergence of \cref{1} to the \textit{nonclassical diffusion equation} (\ref{5}) has been rigorously discussed in \cite{fragou10}.
...
\item The equations for nonclassical (\ref{5}) and classical (\ref{7b}) diffusion are $\ep$-invariant.
\end{itemize}

...
\frame[c]{
	...
	\small{
    In classical particle transport, the incremental probability \textcolor{blue}{$dp$} that a particle will experience a collision while traveling an incremental path length \textcolor{blue}{$ds$} is:
   \[
...
where the total cross section \textcolor{blue}{$\Sigma_t$} is independent of
   \[
      ...
      \]
Assuming that \textcolor{blue}{$
    \Sigma_t = \Sigma_t(s) $ },
the conditional distribution function for distance-to-collision is
  \[ \boxed{\textcolor{blue}{
